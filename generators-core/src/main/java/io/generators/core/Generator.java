...
public interface Generator<T> {
    ...
    /**
     * Returns new generator that generates pair of values from original and passed in generator.
     * @param gen second generqtor
     * @param <B> type of element generated by second generator
     * @return generator generating zipped values
     */
    default <B> Generator<Tuple2<T,B>> zip(Generator<B> gen) {
        return this.map(a -> tuple(a, gen.next()));
    }
